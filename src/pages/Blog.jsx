  ...
  return (
    <>
      ...
      <main className="min-h-screen flex flex-col items-center bg-black pt-24 pb-12 relative">
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold text-indigo-300 mb-8 text-center z-10 relative">Blog</h1>
        <div className="w-full max-w-3xl mx-auto flex-1 flex flex-col gap-0 mt-4 relative px-4 sm:px-8 z-10">
          <motion.div className="relative z-10">
            {loading ? (
              ...
              <div className="w-full text-center text-gray-400 py-4">No blog posts found.</div>
            ) : (
