      ...
      <main className="min-h-screen flex flex-col items-center bg-black pt-24 pb-12 relative">
        ...
        <div className="w-full max-w-4xl mx-auto flex-1 flex flex-col gap-0 mt-4 relative px-4 sm:px-8 z-10">
          ...
          >
            ...
            {blog?.featured && (
              <div className="flex justify-center mb-4">
                <span className="bg-yellow-400 text-black text-sm font-bold px-4 py-2 rounded-full shadow-lg">
                  ⭐ Featured Article
                </span>
              </div>
            )}
            ...
            {/* Summary */}
            {blog?.summary && (
              <div className="text-center text-gray-300 text-lg italic max-w-3xl mx-auto leading-relaxed">
                "{blog.summary}"
              </div>
            )}
          </motion.div>
          ...
          <motion.article
            ...
            className="bg-gradient-to-br from-black/90 via-gray-900/90 to-indigo-900/20 border border-gray-700 rounded-2xl shadow-2xl p-6 sm:p-8 lg:p-10"
          >
          ...
          >
            <Link
              to="/blog"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold shadow-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105"
            >
              <FaArrowLeft size={14} />
